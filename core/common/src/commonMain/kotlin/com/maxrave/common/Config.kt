...
object Config {
    ...
    const val SONARA_WEBSITE_URL = "https://musicapp-lime.vercel.app"
    const val SONARA_ANDROID_DOWNLOAD_URL = "$SONARA_WEBSITE_URL/download/android/latest"
    const val SONARA_GITHUB_OWNER = "safe-rill"
    const val SONARA_GITHUB_REPO = "sonara-music"
    const val SONARA_GITHUB_PROFILE_URL = "https://github.com/$SONARA_GITHUB_OWNER"
    const val SONARA_GITHUB_REPO_URL = "$SONARA_GITHUB_PROFILE_URL/$SONARA_GITHUB_REPO"
    const val SONARA_GITHUB_ISSUES_URL = "$SONARA_GITHUB_REPO_URL/issues"
    const val SONARA_GITHUB_RELEASES_API_URL = "https://api.github.com/repos/$SONARA_GITHUB_OWNER/$SONARA_GITHUB_REPO/releases/latest"

    fun shareTrackUrl(videoId: String): String = "$SONARA_WEBSITE_URL/app/watch?v=$videoId"

    fun sharePlaylistUrl(playlistId: String): String = "$SONARA_WEBSITE_URL/app/playlist?list=$playlistId"
...
object MEDIA_NOTIFICATION {
    ...
    const val NOTIFICATION_CHANNEL_NAME = "Sonara Music Playback Notification"
    const val NOTIFICATION_CHANNEL_ID = "Sonara Music Playback Notification ID"
}
