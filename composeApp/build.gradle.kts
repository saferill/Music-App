                ...
                val macExtraPlistKeys =
                    ...
                    <array>
                        <dict>
                            ...
                            <string>com.saferill.sonara.deeplink</string>
                            <key>CFBundleURLSchemes</key>
                            <array>
                                <string>sonara</string>
                            </array>
                        </dict>
                    </array>
                    """.trimIndent()
...
afterEvaluate {
    ...
    fun packAppImage(isRelease: Boolean) {
        ...
        desktopFile.writeText(
            ...
            |Version=1.0
            |Name=Sonara Music
            |Comment=Sonara Music v$versionName - YouTube Music Client
            |Exec=bin/SonaraMusic %u
            |Icon=simpmusic
            |Terminal=false
        ...
        appRun.writeText(
            ...
            |sed "s|Exec=bin/SonaraMusic|Exec=${'$'}APPIMAGE_PATH|" "${'$'}HERE/simpmusic.desktop" > "${'$'}DESKTOP_DIR/com-maxrave-simpmusic-MainKt.desktop"
